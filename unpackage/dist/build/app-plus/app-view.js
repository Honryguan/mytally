...
var cNN=_mz(z,'scroll-view',['bindscroll',1,'class',1,'data-event-opts',2,'scrollLeft',3,'scrollX',4],[],e,s,gg)
var hON=_n('view')
...
_(l7N,a8N)
_(o6N,l7N)
var cFO=_mz(z,'uni-list',['bind:__l',9,'vueId',1,'vueSlots',2],[],e,s,gg)
var hGO=_n('navigator')
_rz(z,hGO,'url',12,e,s,gg)
var oHO=_mz(z,'uni-list-item',['bind:__l',13,'extraIcon',1,'money',2,'note',3,'showExtraIcon',4,'title',5,'vueId',6],[],e,s,gg)
_(hGO,oHO)
_(cFO,hGO)
var cIO=_mz(z,'uni-list-item',['bind:__l',20,'extraIcon',1,'money',2,'note',3,'showExtraIcon',4,'title',5,'vueId',6],[],e,s,gg)
_(cFO,cIO)
var oJO=_mz(z,'uni-list-item',['bind:__l',27,'extraIcon',1,'money',2,'note',3,'showExtraIcon',4,'title',5,'vueId',6],[],e,s,gg)
_(cFO,oJO)
_(o6N,cFO)
var lKO=_n('navigator')
_rz(z,lKO,'url',34,e,s,gg)
var aLO=_n('view')
...
var oPO=_mz(z,'image',['mode',-1,'class',2,'src',1],[],e,s,gg)
_(bOO,oPO)
_(eNO,bOO)
var xQO=_n('view')
_rz(z,xQO,'class',4,e,s,gg)
var oRO=_mz(z,'input',['name',-1,'class',5,'placeholder',1,'type',2],[],e,s,gg)
_(xQO,oRO)
_(eNO,xQO)
var fSO=_n('view')
_rz(z,fSO,'class',8,e,s,gg)
var cTO=_mz(z,'input',['name',-1,'class',9,'placeholder',1,'type',2],[],e,s,gg)
_(fSO,cTO)
_(eNO,fSO)
var hUO=_mz(z,'button',['class',12,'type',1],[],e,s,gg)
var oVO=_oz(z,14,e,s,gg)
_(hUO,oVO)
_(eNO,hUO)
var cWO=_n('view')
_rz(z,cWO,'class',15,e,s,gg)
var oXO=_mz(z,'view',['bindtap',16,'class',1,'data-event-opts',2],[],e,s,gg)
var lYO=_oz(z,19,e,s,gg)
_(oXO,lYO)
_(cWO,oXO)
var aZO=_n('view')
_rz(z,aZO,'class',20,e,s,gg)
var t1O=_oz(z,21,e,s,gg)
_(aZO,t1O)
_(cWO,aZO)
var e2O=_mz(z,'view',['bindtap',22,'class',1,'data-event-opts',2],[],e,s,gg)
...
var f7O=_mz(z,'input',['focus',-1,'bindconfirm',1,'bindinput',1,'class',2,'confirmType',3,'data-event-opts',4,'maxlength',5,'placeholder',6,'placeholderClass',7,'type',8,'value',9],[],e,s,gg)
_(o6O,f7O)
_(x5O,o6O)
var c8O=_mz(z,'cg-swiper',['bind:__l',11,'bind:clickItem',1,'data-event-opts',2,'swiperList',3,'vueId',4],[],e,s,gg)
_(x5O,c8O)
var h9O=_mz(z,'button',['bindtap',16,'data-event-opts',1,'type',2],[],e,s,gg)
...
var z=gz$gwx_14()
var oBP=_n('view')
var lCP=_mz(z,'uni-section',['bind:__l',0,'class',1,'sumTitle',1,'title',2,'type',3,'vueId',4],[],e,s,gg)
_(oBP,lCP)
var aDP=_mz(z,'uni-list',['bind:__l',6,'vueId',1,'vueSlots',2],[],e,s,gg)
var tEP=_v()
_(aDP,tEP)
var eFP=function(oHP,bGP,xIP,gg){
var fKP=_mz(z,'uni-list-item',['badgeText',13,'bind:__l',1,'extraIcon',2,'money',3,'note',4,'showArrow',5,'showExtraIcon',6,'title',7,'vueId',8],[],oHP,bGP,gg)
_(xIP,fKP)
return xIP
}
tEP.wxXCkey=4
_2z(z,11,eFP,e,s,gg,tEP,'item','index','index')
_(oBP,aDP)
_(r,oBP)
return r
}
